...
let songs = [
    ...
    },
    {
        ...
        lyrics: [
            ...
            { time: 39.5, text: "Sometimes a happiness is just a happiness" },
            { time: 51.9, text: "I've never been enjoying my serenity" },
            { time: 57, text: "Even if I've got a lot of company" },
            { time: 62.8, text: "That makes me happy" },
            { time: 66.7, text: "Soul try to figure it out" },
            { time: 71, text: "From where I've been escaping" },
            { time: 75.8, text: "Running to end all the sin" },
            { time: 80, text: "Get away from the pressure" },
            { time: 83.6, text: "Wondering to get a love that is so pure" },
            { time: 92.5, text: "Gotta have to always make sure" },
            { time: 96.7, text: "That I'm not just somebody's pleasure" },
            { time: 104, text: "I always pretending and lying" },
            { time: 110.5, text: "I got used to feel empty" },
            { time: 112.6, text: "'Cause all I got is unhappy" },
            ...
            { time: 133, text: "That makes me happy" },
            { time: 138.8, text: "And I don't even feel my own pain" },
            { time: 144, text: "Whatever when the storms pouring rain" },
            { time: 150, text: "Feels like a wind" },
            { time: 153.8, text: "Soul try to figure it out" },
            { time: 157.8, text: "From where I've been escaping" },
            { time: 162.4, text: "Running to end all the sin" },
            { time: 167, text: "Get away from the pressure" },
            { time: 170.6, text: "Wondering to get a love that is so pure" },
            { time: 179.4, text: "Gotta have to always make sure" },
            { time: 183.6, text: "That I'm not just somebody's pleasure" },
            { time: 190.5, text: "I hold imagination" },
